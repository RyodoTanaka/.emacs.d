...
lineskip=-0.5ex}")
 ...
 '(package-selected-packages
   (quote
    (ox-gfm yatex yaml-mode which-key web-mode use-package symbol-overlay smooth-scroll smart-jump slime-company rainbow-delimiters neotree mozc minimap magit lsp-ui lsp-treemacs leaf-keywords ivy-rich imenu-list highlight-indent-guides hide-mode-line google-c-style flycheck elscreen el-get doom-themes doom-modeline counsel company-quickhelp company-math company-lsp company-irony company-c-headers company-box company-auctex cmake-mode ccls avy-migemo all-the-icons-ivy)))
